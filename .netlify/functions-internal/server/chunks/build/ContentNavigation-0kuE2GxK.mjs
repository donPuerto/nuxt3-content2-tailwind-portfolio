...
import { p as useState, a as useAsyncData, d as useRuntimeConfig, e as __nuxt_component_0$1 } from './server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BCm8oN5n.mjs';
import { a as useContentPreview } from './preview-D_6nC1AN.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BuaJCljf.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-0kuE2GxK.mjs.map
