import { C as withLeadingSlash, r as joinURL, z as withoutTrailingSlash, D as withBase, E as hash } from '../runtime.mjs';
import { d as useRuntimeConfig } from './server.mjs';
import { u as useRequestEvent, a as useContentPreview } from './preview-D_6nC1AN.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BuaJCljf.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BCm8oN5n.mjs.map
