...
const buttonPosition = computed(() => {
  switch (props.position) {
    ...
    case 'top-left':
      return 'fixed top-8 left-8'
    case 'top-right':
      return 'fixed top-8 right-8'
...
.glow-effect {
  box-shadow: 0 0 10px theme('colors.primary.DEFAULT / 30%'),
              0 0 20px theme('colors.primary.DEFAULT / 15%'),
  ...
  0% {
   ...
   50% {
    box-shadow: 0 0 15px theme('colors.primary.DEFAULT / 40%'),
                 0 0 25px theme('colors.primary.DEFAULT / 20%'),
                 0 0 35px theme('colors.primary.DEFAULT / 15%');
  }
  100% {
    box-shadow: 0 0 10px theme('colors.primary.DEFAULT / 30%'),
                 0 0 20px theme('colors.primary.DEFAULT / 15%'),
