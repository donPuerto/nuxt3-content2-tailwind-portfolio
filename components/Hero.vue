<template>
  <div class="flex flex-col justify-center align-center lg:flex-row lg:mt-8">
    <div class="flex flex-col justify-center lg:w-1/2 lg:pr-3">
      <p class="text-gray-300">Computer Engineer by Profession &trade;</p>
      <h1 class="text-4xl sm:text-5xl text-gray-100 uppercase font-black mt-2 sm:mt-3">Don Puerto</h1>
      ...
      <div class="flex flex-col sm:flex-row space-y-3 sm:space-x-3 sm:space-y-0 mt-5">
        <a
    ...
    <div class="flex rounded shadow lg:w-1/2 overflow-hidden mt-5 lg:mt-0">
      <div>
        ...
        <p class="text-xl text-gray-700 italic bg-gray-100 border-t px-8 py-5">
          &quot;there’s two types of people, either you can punch in your dreams or you can’t&quot;
        </p>
      </div>
    </div>
  </div>
